...
func (s *SmartContract) Invoke(APIstub shim.ChaincodeStubInterface) sc.Response {
	...
	case "test1":
		return s.test1(APIstub, args)
	case "test2":
		return s.test2(APIstub, args)
	case "test3":
		return s.test3(APIstub, args)
	case "test4":
		return s.test4(APIstub, args)
...
//포인트 생성
func (s *SmartContract) test1(APIstub shim.ChaincodeStubInterface, args []string) sc.Response {
...
//거래 기능(현제 문제)
func (s *SmartContract) test3(APIstub shim.ChaincodeStubInterface, args []string) sc.Response {
...
//거래내역 조회
func (s *SmartContract) test4(APIstub shim.ChaincodeStubInterface, args []string) sc.Response {
