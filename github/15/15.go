...
func (s *SmartContract) initLedger(APIstub shim.ChaincodeStubInterface) sc.Response {
	benhsois := []Benhsoi{
		Benhsoi{Mabenhsoi: "benhsoi01", Ngaynhap: "2021-01-02", Thongtinchitiet: "phuong12##quan01##tinhtrangbenhbinhthuong##", Nhanviencdc: "cdc01"},
		Benhsoi{Mabenhsoi: "benhsoi02", Ngaynhap: "2021-01-02", Thongtinchitiet: "phuong12##quan01##tinhtrangbenhbinhthuong##", Nhanviencdc: "cdc01"},
		Benhsoi{Mabenhsoi: "benhsoi03", Ngaynhap: "2021-01-12", Thongtinchitiet: "phuong12##quan01##tinhtrangbenhbinhnang##", Nhanviencdc: "cdc01"},
		Benhsoi{Mabenhsoi: "benhsoi04", Ngaynhap: "2021-01-12", Thongtinchitiet: "phuong12##quan01##tinhtrangbenhbinhnang##", Nhanviencdc: "cdc05"},
		Benhsoi{Mabenhsoi: "benhsoi05", Ngaynhap: "2021-03-12", Thongtinchitiet: "phuong12##quan01##tinhtrangbenhbinhnang##", Nhanviencdc: "cdc02"},
		Benhsoi{Mabenhsoi: "benhsoi06", Ngaynhap: "2021-03-12", Thongtinchitiet: "phuong12##quan01##tinhtrangbenhbinhthuong##", Nhanviencdc: "cdc02"},
		Benhsoi{Mabenhsoi: "benhsoi07", Ngaynhap: "2021-03-14", Thongtinchitiet: "phuong12##quan01##tinhtrangbenhbinhthuong##", Nhanviencdc: "cdc04"},
		Benhsoi{Mabenhsoi: "benhsoi08", Ngaynhap: "2021-03-15", Thongtinchitiet: "phuong12##quan01##tinhtrangbenhbinhnang##", Nhanviencdc: "cdc04"},
		Benhsoi{Mabenhsoi: "benhsoi09", Ngaynhap: "2021-03-16", Thongtinchitiet: "phuong12##quan01##tinhtrangbenhbinhthuong##", Nhanviencdc: "cdc03"},
		Benhsoi{Mabenhsoi: "benhsoi10", Ngaynhap: "2021-03-16", Thongtinchitiet: "phuong12##quan01##tinhtrangbenhbinhthuong##", Nhanviencdc: "cdc03"},
	}

	i := 0
	for i < len(benhsois) {
		benhsoiAsBytes, _ := json.Marshal(benhsois[i])
		APIstub.PutState("BENHSOI"+strconv.Itoa(i), benhsoiAsBytes)
		i = i + 1
	}
