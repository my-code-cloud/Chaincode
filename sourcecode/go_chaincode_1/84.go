...
func (s* SmartContract)GetKeyRange(ctx contractapi. TransactionContextInterface, args ...string) ([]Asset, error) {
	var startKey string = ""
	var endKey string= ""
	if len(args) == 1 {
		startKey = ""
		...
		return nil, fmt.Errorf("Invalid number of argments : %s", len(args))
	}
