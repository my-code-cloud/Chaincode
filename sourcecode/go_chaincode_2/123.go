...
type documentsChaincode struct {
}
...
func (cc *documentsChaincode) create(stub shim.ChaincodeStubInterface, arg []string) peer.Response {
    ...
    data := documents{ Id: args[0], CreatedOn: dateValue1, CreatedBy: args[2], IsDelete: boolValue3, DPRNo: args[4], DocType: args[5], DocumentHash: args[6], Status: args[7], Notes: args[8] }
...
func (cc *documentsChaincode) get(stub shim.ChaincodeStubInterface, args []string) peer.Response {
...
func (cc *documentsChaincode) delete(stub shim.ChaincodeStubInterface, args []string) peer.Response {
...
func (cc *documentsChaincode) update(stub shim.ChaincodeStubInterface, arg []string) peer.Response {
...
func (cc *documentsChaincode) history(stub shim.ChaincodeStubInterface, args []string) peer.Response {
...
func (cc *documentsChaincode) querystring(stub shim.ChaincodeStubInterface, args []string) peer.Response {
...
func (cc *documentsChaincode) Init(stub shim.ChaincodeStubInterface) peer.Response {
	return shim.Success(nil)
}

func (cc *documentsChaincode) Invoke(stub shim.ChaincodeStubInterface) peer.Response {
...
func main() {
	...
	err := shim.Start(new(documentsChaincode))
	if err != nil {
